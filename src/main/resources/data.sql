...
insert into users(id, email, password_hash, salt, username, role_id) values ('1000', 'test@gmail.com', '$2a$12$V7b/Sa.6u7N5qM0/iwBEC.l32sWeNOW5tnIj/XaW4LHCRY7radPfS', '[�7�', 'test','2');
...
insert into packages(id, tracker, recipient_id, sender_id, destination_address, shipping_address) values (1000, 'QWERTY', '1', '2', 'Warsaw', 'Krakow');
